...
*Image above is from the [reverse reads](FastQC/Pd8825_2_fastqc.html).*
</details>
...
*Image above is from the [reverse reads](FastQC/Pd8825_2_trimmed_fastqc.html).*
</details>
...
| ------------- | ------------- | -------------- |
| [Raw Forward](FastQC/Pd8825_1_fastqc.html)  | 7692782  | ~12% |
| Raw Reverse  | 7692782  | ~12% |
| Trimmed Forward  | 6356740  | ~2% |
| Trimmed Reverse  | 6356740  | ~2% |

***NOTE:** HTML files from the FastQC before and after trimming can be found under the [FastQC](FastQC) directory and are linked in the table above.*
## Assembly
